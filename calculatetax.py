...
def calculate_tax(all_trades, CGTCalc=True, reportfile=None, reportinglevel="NORMAL", fxsource="DATABASE",
                  fx_from_date=None, fx_to_date=None):
    """
    Calculate the tax
    ...
    trade_dict_bycode = all_trades.separate_code()
    trade_dict_bycode.add_cumulative_data()
    trade_dict_bycode.generate_pseudo_trades()
